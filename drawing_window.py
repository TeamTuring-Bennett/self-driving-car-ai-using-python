...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.start_button = Button(
            self.root, text="Place Starting Line", command=self.use_start
        )
    ...
    def export(self):
        ...
        if self.start_made:
            ...
            savename = simpledialog.askstring(
                "Save track as PNG",
                "Please pick a name for the track. \n (Do not use any extentions)",
            )
            ...
            messagebox.showwarning(
                ...
                " A starting line has not been made. Please make a starting line then retry saving.",
            )
            self.use_track()
